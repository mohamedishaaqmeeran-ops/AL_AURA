...
export default function Guarantee() {
  ...
  return (
    <Box sx={{ mt: 10, mb: 10, px: { xs: 0, sm: 6, md: 12 }, textAlign: "center", overflowX:"hidden" }}>
     ...
     <Grid container spacing={{ lg: 15, xs: 6 }} justifyContent="center">
  {guarantees.map((g, i) => (
    <Grid
      key={i}
      item
      ...
      sm={6}
      md={4}
      sx={{ height: "auto", display: "flex", justifyContent: "center" }} // center cards on iPhone
      data-aos="fade-up"
      data-aos-delay={i * 200}
    >
      <Box
        sx={{
          width: { lg: 200, md: 250, sm: 300, xs: "90%" }, // responsive width for iPhone
          maxWidth: 350,
          p: { xs: 3, sm: 5 }, // smaller padding on iPhone
          borderRadius: 3,
