...
const services = [
  { title: "Website / Web App Development", icon: <ComputerIcon fontSize="large" />, desc: "Responsive and custom-built business websites, portfolios, e-commerce and web applications." },
...
export default function Service_Contents() {
  ...
  return (
    <Box sx={{ py: 6, maxWidth: "1200px", mx: "auto", px: 2, mt: 10, mb: 10 }}>
      ...
      <Grid container rowSpacing={0} columnSpacing={{ xs: 25, xl: 26 }}>
          ...
          >
            <Card
              sx={{
                mt: 10,
                p: 2,
                width: { sm: "80vw", xs: "90%", lg: "32.5vw", md: "87.5vw", xl: "30vw" },
                textAlign: "center",
                height: "60%",
                borderRadius: "20px",
            ...
            >
              <CardContent>
                ...
                <Typography variant="h6" sx={{ fontWeight: "bold", mt: 1, mb: 1, color: "#2d013bff" }}>
                  {service.title}
                </Typography>
      ...
      {/* ⭐ Button Animation */}
      <Box sx={{ textAlign: "center", mt: 5 }} data-aos="zoom-in">
        <Button
          variant="contained"
          size="large"
          sx={{
